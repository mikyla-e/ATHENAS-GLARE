...
urlpatterns = [
    ...
    path('customers/customer_page/<int:customer_id>/', views.customer_page, name='customer_page'),
    path('customers/customer_edit/<int:customer_id>/', views.customer_edit, name='customer_edit'),
    # path('customers/vehicle/', views.vehicle_details, name='vehicle_details'),
    path('vehicle/<int:vehicle_id>/details/', views.vehicle_details, name='vehicle_details'),
    path('payrolls/print/', views.print, name='print'),
    ...
    path('payrolls/payslip/<int:payroll_period_id>/', views.payslip, name='payslip'),
    #new - flores
